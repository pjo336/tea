...
const configTemplates: Template[] = [
  {
...
const NEW_PROJECT_TEMPLATES: Template[] = [...configTemplates, ...srcTemplates, ...rootTemplates];

export default NEW_PROJECT_TEMPLATES;
